...
texts = {
    ...
    "instructions": [
        ...
        "          loses through damages (shots, lava) over time",
    ...
    if language == "German":
        texts = {
            ...
            "instructions": [
                ...
                "       one-shot-kill for enemies",
                "       Ziel: survive as long as you can, make a new highscore",
                "   Survival2:",
                "       Always has 3 Robots, everytime one dies, a faster one apppears",
                "       verstecken im Gebüsch funktioniert in survival mode nicht",
                "       one-shot-kill for enemies",
